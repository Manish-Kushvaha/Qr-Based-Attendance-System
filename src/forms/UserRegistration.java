  ...
  private String saveImage(String email) {
    if (originalImage != null && selectedFile != null) {
        try {
            ...
            String savePath = "C:\\Users\\HP\\Documents\\NetBeansProjects\\AttendanceManagementSystemBD\\src\\images"; // or a full path like "C:\\path\\to\\images\\"
           ...
           BufferedImage scaledImage = BDUtility.scaleImage(originalImage, originalImage);
            ImageIO.write(scaledImage, extension, saveFile);

            // Return the image name or the full path depending on how you want to store it in the DB
            return imageName; // or "images/" + imageName if you store the full path in the DB
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
